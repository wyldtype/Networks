...
TODO: use anything useful in this script for QC of power in different organisms, but don't get bogged down in all the complexities of comparing models etc.
```{r}
